...
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS title VARCHAR(120) NULL AFTER id;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS num_teams TINYINT UNSIGNED NOT NULL DEFAULT 2 AFTER match_date;
...
ALTER TABLE `matches` ADD INDEX IF NOT EXISTS `idx_matches_draw_mode` (draw_mode);
ALTER TABLE `matches` ADD UNIQUE KEY IF NOT EXISTS `idx_matches_public_token` (public_token);
ALTER TABLE `match_teams` ADD INDEX IF NOT EXISTS `idx_match_teams_captain` (captain_player_id);
ALTER TABLE `match_players` ADD INDEX IF NOT EXISTS `idx_match_lineup` (match_id, team_number, assigned_position, lineup_order);
ALTER TABLE `match_players` ADD INDEX IF NOT EXISTS `idx_match_availability` (match_id, availability_status);

-- Datos actuales con upsert
...
(6,'PELA','DEL','lento','4.4','5.0','3.0','5.0','6.0','2.0',NULL,1,'2026-03-18 03:59:04','2026-05-05 02:53:52'),
...
(14,'PABLO','DEF','rapido','4.0','3.0','5.0','6.0','3.0','3.0',NULL,1,'2026-03-18 03:59:04','2026-05-05 02:31:47'),
(15,'MAURI','DEL','lento','2.8','3.0','2.0','3.0','3.0','3.0',NULL,1,'2026-03-18 03:59:04','2026-05-05 02:00:13'),
(16,'ALE CUERVO','DEF','rapido','3.2','3.0','4.0','3.0','3.0','3.0',NULL,1,'2026-03-18 03:59:04','2026-05-05 02:21:46'),
...
(23,'CRISTIAN','DEL','lento','1.6','1.0','2.0','3.0','1.0','1.0',NULL,1,'2026-03-18 03:59:04','2026-05-05 02:00:13'),
...
(29,'TEBO','MED/DEL','rapido','5.0','5.0','6.0','4.0','5.0','5.0',NULL,1,'2026-05-05 01:50:25','2026-05-05 02:50:00')
...
ALTER TABLE `match_round_robin_results` AUTO_INCREMENT=355;
...
-- Backfill de campos calculados si faltaban
UPDATE players SET technique=COALESCE(technique, skill), rhythm=COALESCE(rhythm, CASE WHEN pace='lento' THEN 2.0 ELSE 4.0 END), defense_physical=COALESCE(defense_physical, 3.0), attack=COALESCE(attack, skill), teamwork=COALESCE(teamwork, skill), goalkeeper_skill=COALESCE(goalkeeper_skill, CASE WHEN positions LIKE '%ARQ%' THEN skill ELSE NULL END);
UPDATE players SET pace=CASE WHEN rhythm <= 3.0 THEN 'lento' ELSE 'rapido' END WHERE rhythm IS NOT NULL;

...
-- Generado: 2026-05-05 18:20:32
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS=0;
CREATE DATABASE IF NOT EXISTS `u552541920_futbol` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `u552541920_futbol`;

-- Estructura: captain_drafts
...
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `match_id` int(10) unsigned NOT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `captain1_player_id` int(10) unsigned NOT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `captain2_player_id` int(10) unsigned NOT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `captain3_player_id` int(10) unsigned DEFAULT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `captain4_player_id` int(10) unsigned DEFAULT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `captain1_token` varchar(64) NOT NULL DEFAULT '';
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `captain2_token` varchar(64) NOT NULL DEFAULT '';
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `captain3_token` varchar(64) DEFAULT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `captain4_token` varchar(64) DEFAULT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `current_team` tinyint(3) unsigned DEFAULT '1';
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `status` enum('active','completed') NOT NULL DEFAULT 'active';
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `started_at` datetime DEFAULT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `completed_at` datetime DEFAULT NULL;
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `turn_version` int(10) unsigned NOT NULL DEFAULT '0';
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `created_at` timestamp NOT NULL DEFAULT 'current_timestamp()';
ALTER TABLE `captain_drafts` ADD COLUMN IF NOT EXISTS `updated_at` timestamp NOT NULL DEFAULT 'current_timestamp()' on update current_timestamp();

-- Estructura: captain_picks
...
ALTER TABLE `captain_picks` ADD COLUMN IF NOT EXISTS `id` int(10) unsigned NOT NULL auto_increment;
ALTER TABLE `captain_picks` ADD COLUMN IF NOT EXISTS `match_id` int(10) unsigned NOT NULL;
ALTER TABLE `captain_picks` ADD COLUMN IF NOT EXISTS `player_id` int(10) unsigned NOT NULL;
ALTER TABLE `captain_picks` ADD COLUMN IF NOT EXISTS `team_number` tinyint(3) unsigned NOT NULL;
ALTER TABLE `captain_picks` ADD COLUMN IF NOT EXISTS `picked_by_player_id` int(10) unsigned NOT NULL;
ALTER TABLE `captain_picks` ADD COLUMN IF NOT EXISTS `pick_order` smallint(5) unsigned NOT NULL;
ALTER TABLE `captain_picks` ADD COLUMN IF NOT EXISTS `created_at` timestamp NOT NULL DEFAULT 'current_timestamp()';

-- Estructura: match_awards
...
ALTER TABLE `match_awards` ADD COLUMN IF NOT EXISTS `id` int(10) unsigned NOT NULL auto_increment;
ALTER TABLE `match_awards` ADD COLUMN IF NOT EXISTS `match_id` int(10) unsigned NOT NULL;
ALTER TABLE `match_awards` ADD COLUMN IF NOT EXISTS `award_code` varchar(40) NOT NULL;
ALTER TABLE `match_awards` ADD COLUMN IF NOT EXISTS `player_id` int(10) unsigned NOT NULL;
ALTER TABLE `match_awards` ADD COLUMN IF NOT EXISTS `notes` varchar(255) DEFAULT NULL;
ALTER TABLE `match_awards` ADD COLUMN IF NOT EXISTS `created_at` timestamp NOT NULL DEFAULT 'current_timestamp()';
ALTER TABLE `match_awards` ADD COLUMN IF NOT EXISTS `updated_at` timestamp NOT NULL DEFAULT 'current_timestamp()' on update current_timestamp();

-- Estructura: match_players
...
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `id` int(10) unsigned NOT NULL auto_increment;
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `match_id` int(10) unsigned NOT NULL;
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `player_id` int(10) unsigned NOT NULL;
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `team_number` tinyint(3) unsigned DEFAULT NULL;
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `assigned_position` enum('ARQ','DEF','MED','DEL') DEFAULT NULL;
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `is_goalkeeper` tinyint(1) NOT NULL DEFAULT '0';
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `lineup_order` smallint(5) unsigned DEFAULT NULL;
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `formation_line_order` tinyint(3) unsigned DEFAULT NULL;
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `availability_status` enum('convocado','confirmado','baja') NOT NULL DEFAULT 'convocado';
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `goals` smallint(5) unsigned NOT NULL DEFAULT '0';
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `rating` decimal(3,1) DEFAULT NULL;
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `created_at` timestamp NOT NULL DEFAULT 'current_timestamp()';
ALTER TABLE `match_players` ADD COLUMN IF NOT EXISTS `updated_at` timestamp NOT NULL DEFAULT 'current_timestamp()' on update current_timestamp();

-- Estructura: match_round_robin_results
...
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `id` int(10) unsigned NOT NULL auto_increment;
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `match_id` int(10) unsigned NOT NULL;
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `home_team_number` tinyint(3) unsigned NOT NULL;
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `away_team_number` tinyint(3) unsigned NOT NULL;
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `leg` tinyint(3) unsigned NOT NULL;
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `home_goals` smallint(5) unsigned DEFAULT NULL;
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `away_goals` smallint(5) unsigned DEFAULT NULL;
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `created_at` timestamp NOT NULL DEFAULT 'current_timestamp()';
ALTER TABLE `match_round_robin_results` ADD COLUMN IF NOT EXISTS `updated_at` timestamp NOT NULL DEFAULT 'current_timestamp()' on update current_timestamp();

-- Estructura: match_teams
...
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `id` int(10) unsigned NOT NULL auto_increment;
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `match_id` int(10) unsigned NOT NULL;
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `team_number` tinyint(3) unsigned NOT NULL;
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `team_name` varchar(80) DEFAULT NULL;
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `captain_player_id` int(10) unsigned DEFAULT NULL;
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `total_skill` decimal(5,1) NOT NULL DEFAULT '0.0';
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `formation_name` varchar(80) DEFAULT NULL;
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `formation_data` text DEFAULT NULL;
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `color_name` varchar(40) DEFAULT NULL;
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `goals` smallint(5) unsigned NOT NULL DEFAULT '0';
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `created_at` timestamp NOT NULL DEFAULT 'current_timestamp()';
ALTER TABLE `match_teams` ADD COLUMN IF NOT EXISTS `updated_at` timestamp NOT NULL DEFAULT 'current_timestamp()' on update current_timestamp();
...
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `id` int(10) unsigned NOT NULL auto_increment;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `title` varchar(120) DEFAULT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `match_date` datetime NOT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `num_teams` tinyint(3) unsigned NOT NULL DEFAULT '2';
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `players_per_team` tinyint(3) unsigned NOT NULL DEFAULT '9';
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `max_diff` decimal(4,1) NOT NULL DEFAULT '2.0';
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `status` enum('programado','sorteado','finalizado') NOT NULL DEFAULT 'programado';
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `draw_mode` enum('none','random','captains','manual') NOT NULL DEFAULT 'none';
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `draw_started_at` datetime DEFAULT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `draw_completed_at` datetime DEFAULT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `finalized_at` datetime DEFAULT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `formation_edit_deadline` datetime DEFAULT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `public_token` varchar(64) DEFAULT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `notes` text DEFAULT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `result_notes` text DEFAULT NULL;
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `round_robin_legs` tinyint(3) unsigned NOT NULL DEFAULT '2';
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `created_at` timestamp NOT NULL DEFAULT 'current_timestamp()';
ALTER TABLE `matches` ADD COLUMN IF NOT EXISTS `updated_at` timestamp NOT NULL DEFAULT 'current_timestamp()' on update current_timestamp();
...
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `id` int(10) unsigned NOT NULL auto_increment;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `name` varchar(120) NOT NULL;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `positions` varchar(20) NOT NULL;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `pace` enum('rapido','lento') NOT NULL DEFAULT 'rapido';
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `skill` decimal(3,1) NOT NULL DEFAULT '1.0';
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `technique` decimal(3,1) DEFAULT NULL;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `rhythm` decimal(3,1) DEFAULT NULL;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `defense_physical` decimal(3,1) DEFAULT NULL;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `attack` decimal(3,1) DEFAULT NULL;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `teamwork` decimal(3,1) DEFAULT NULL;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `goalkeeper_skill` decimal(3,1) DEFAULT NULL;
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `active` tinyint(1) NOT NULL DEFAULT '1';
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `created_at` timestamp NOT NULL DEFAULT 'current_timestamp()';
ALTER TABLE `players` ADD COLUMN IF NOT EXISTS `updated_at` timestamp NOT NULL DEFAULT 'current_timestamp()' on update current_timestamp();
...
('8', 'NICO', 'MED', 'rapido', '3.9', '5.0', '4.0', '2.0', '5.0', '3.0', NULL, '1', '2026-03-18 03:59:04', '2026-05-05 11:15:15'),

...
Incluye:
- Correccion visual de la cancha/formaciones en capitanes.php.
- Editor admin de formaciones con controles +/- compactados para mobile.
- Reflejo de formaciones guardadas en index.php/inicio con orden correcto.

...
function ensure_control_schema(): array
{
    ...
    $columns = [
        ...
        ['players', 'pass_vision', 'pass_vision DECIMAL(3,1) NULL AFTER technique'],
        ['players', 'rhythm', 'rhythm DECIMAL(3,1) NULL AFTER pass_vision'],
        ['players', 'stamina', 'stamina DECIMAL(3,1) NULL AFTER rhythm'],
        ['players', 'defense_physical', 'defense_physical DECIMAL(3,1) NULL AFTER stamina'],
        ...
        $pdo->exec(
            "UPDATE players
             SET
               ...
               pass_vision = COALESCE(pass_vision, technique, skill),
               rhythm = COALESCE(rhythm, CASE WHEN pace = 'lento' THEN 2.0 ELSE 4.0 END),
               stamina = COALESCE(stamina, rhythm, CASE WHEN pace = 'lento' THEN 2.8 ELSE 3.8 END),

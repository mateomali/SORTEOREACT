...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save') {
        ...
        $stamina = normalize_player_stat($_POST['stamina'] ?? null, $rhythm);
        ...
        if ($id > 0) {
            ...
            $stmt = $pdo->prepare(
                'INSERT INTO players
                   (name, positions, pace, skill, technique, rhythm, stamina, defense_physical, attack, teamwork, mentality, regularity, goalkeeper_skill, active)
                 VALUES
                   (:name, :positions, :pace, :skill, :technique, :rhythm, :stamina, :defense_physical, :attack, :teamwork, :mentality, :regularity, :goalkeeper_skill, :active)'
            );
            $stmt->execute([
...
$statHelp = [
    ...
    'stamina' => 'Capacidad de sostener el esfuerzo, seguir volviendo, presionando y marcando durante todo el partido.',
...
$fieldWeightHelp = [
    'Defensor' => 'Solidez 26%, Resistencia 18%, Velocidad 16%, Tecnica 16%, Juego en equipo 12%, Mentalidad 12%, Ataque 6%.',
    'Lateral' => 'Velocidad 22%, Solidez 20%, Resistencia 18%, Tecnica 16%, Juego en equipo 14%, Ataque 7%, Mentalidad 3%.',
    'Mediocampista' => 'Tecnica 22%, Velocidad 18%, Juego en equipo 18%, Resistencia 15%, Mentalidad 12%, Solidez 9%, Ataque 6%.',
    'Delantero' => 'Ataque 30%, Velocidad 20%, Tecnica 16%, Juego en equipo 12%, Resistencia 10%, Mentalidad 8%, Solidez 4%.',
    'Arquero' => 'Habilidad de arquero 38%, Solidez 12%, Juego en equipo 14%, Velocidad 8%, Resistencia 8%, Tecnica 10%, Mentalidad 10%.',

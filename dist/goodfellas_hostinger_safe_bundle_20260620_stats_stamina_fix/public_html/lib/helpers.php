...
{
    return ['technique', 'rhythm', 'stamina', 'defense_physical', 'attack', 'teamwork', 'mentality', 'regularity', 'goalkeeper_skill'];
}

function player_field_stat_fields(): array
{
    return ['technique', 'rhythm', 'stamina', 'defense_physical', 'attack', 'teamwork', 'mentality', 'regularity'];
}
...
function player_normalize_position_stat_weights(array $weights): array
{
    ...
    $allowedFields = ['goalkeeper_skill', 'defense_physical', 'rhythm', 'stamina', 'technique', 'teamwork', 'mentality', 'attack'];
    $normalized = [];

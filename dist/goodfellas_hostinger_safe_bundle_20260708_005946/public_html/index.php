...
function home_player_card_stats(array $player, string $position): array
{
    if ($position === 'ARQ') {
        return [
            ...
            'VEL' => home_player_card_stat_value($player, 'rhythm'),
                    ...
                    <?php else: ?>
                      <?php foreach ($linePlayers as $player): ?>
                        ...
                        <div
                          ...
                          data-player-pass-vision="<?= h(number_format(player_effective_stat($player, 'pass_vision'), 1, '.', '')) ?>"
                          data-player-rhythm="<?= h(number_format(player_effective_stat($player, 'rhythm'), 1, '.', '')) ?>"
                          data-player-stamina="<?= h(number_format(player_effective_stat($player, 'stamina'), 1, '.', '')) ?>"
